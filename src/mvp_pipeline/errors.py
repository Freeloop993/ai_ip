ERRORS = {
    ...
    "COLLECTOR_PLATFORM_UNSUPPORTED": "Native collector platform is unsupported.",
    "COLLECTOR_INVALID_PROFILE_URL": "Native collector profile URL is invalid.",
    "COLLECTOR_REQUEST_FAILED": "Native collector request failed.",
